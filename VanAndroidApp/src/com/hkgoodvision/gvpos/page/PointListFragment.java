...
//		}
	...
	private void initFrameListViewData() {
		// 初始化Handler
		listViewServiceHandler = this.getLvHandler(serviceListView, listViewServiceAdapter, lvNews_foot_more, lvNews_foot_progress, AppContext.PAGE_SIZE);
	...
	private void initNewsListView() {
		...
		listViewServiceAdapter = new ListViewServiceAdapter(this.getActivity(), serviceListData,
				R.layout.point_listing_list_item);
