 ...
 * @created 2012-3-21
 */
public class ListViewMembershipAdapter extends BaseAdapter {
	private Context 					context;//运行上下文
	private List<EarnPoint> 					listItems;//数据集合
	 ...
	 * @param resource
	 */
	public ListViewMembershipAdapter(Context context, List<EarnPoint> data,int resource) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			listItemView.title = (TextView)convertView.findViewById(R.id.membership_company_name_text);
			//listItemView.address = (TextView)convertView.findViewById(R.id.servicelist_listitem_address);
			listItemView.pointearn = (TextView)convertView.findViewById(R.id.membership_point_text);
		...
		//设置文字和图片
		EarnPoint service = listItems.get(position);
		...
		listItemView.title.setText(service.getServiceName());
