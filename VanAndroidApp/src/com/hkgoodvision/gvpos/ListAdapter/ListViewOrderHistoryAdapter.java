 ...
 * @created 2012-3-21
 */
public class ListViewOrderHistoryAdapter extends BaseAdapter {
	 ...
	 * @param resource
	 */
	public ListViewOrderHistoryAdapter(Context context, List<Service> data,int resource) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			//获取控件对象
			listItemView.title = (TextView)convertView.findViewById(R.id.orderhistory_listitem_title);
			listItemView.address = (TextView)convertView.findViewById(R.id.orderhistory_listitem_address);
			listItemView.pointearn = (TextView)convertView.findViewById(R.id.orderhistory_listitem_point);
			listItemView.phone = (TextView)convertView.findViewById(R.id.orderhistory_listitem_phone);
			listItemView.remark = (TextView)convertView.findViewById(R.id.orderhistory_listitem_remark);
...
//		}
		...
		listItemView.phone.setText("電話:"+service.getCustPhone());
		listItemView.remark.setText(service.getRemark());
