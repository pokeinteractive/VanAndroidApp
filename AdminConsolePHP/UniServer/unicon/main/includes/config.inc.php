...
//=== MySQL ===
define("US_DB_HOST",            "127.0.0.1");           // Set dbhost to 127.0.0.1 for W7 IPV6 issues
...
define("USF_PHP_INI_PROD",      US_PHP."/php.ini_production_nano");      //PHP configuration production
define("USF_PHP_INI_DEV",       US_PHP."/php.ini_development_nano");     //PHP configuration development
