...
?>
 ...
 <table>
   ...
   <td>
    <ul>
      <li> Apache 2.2.17</li>
      <li> MySQL 5.5.10-community</li>
      <li> PHP 5.3.5</li>
      <li> eAccelerator 1.0-snv427</li>
      <li> phpMyAdmin  3.3.9.2</li>
      <li> ActivePerl 5.10.1.1005 - <a href="http://wiki.uniformserver.com/index.php/5.0-Nano:_Perl#Plugins">Plugin</a></li>
      <li> ActivePerl 5.10.1.1006 - <a href="http://wiki.uniformserver.com/index.php/5.0-Nano:_Perl#Plugins">Plugin</a></li>
      <li> ActivePerl 5.10.1.1007 - <a href="http://wiki.uniformserver.com/index.php/5.0-Nano:_Perl#Plugins">Plugin</a></li>
      <li> UniTray</li>
    </ul>
   </td>
   <td>
